...
// Must be caught as a compile failure with a diagnostic containing the expect
// string. This proves the harness itself works before any real negative TUs are
// added (T012).
//
// platforms: all
// expect: declared
