...
- [X] T016 Final privacy-contract sweep: re-run quickstart sections 2–9 and 11–13 verdicts against the final HEAD state; record each command and its binary verdict in the pull-request body as the change's evidence (X.4).
